...
const CreateSpaceSheet = () => {
    const { isCreateSpaceOpen, closeCreateSpaceSheet } = useSheetStore();
    ...
    const handleCreateSpace = async (data: any) => {
        try {
            ...
            const response = await fetch(`${BE_URL}/space/create`, {
                method: 'POST',
                headers,
                body: JSON.stringify({
                    name: data.spaceName,
            ...
            toast("An error occurred while creating the space");
        }
    };
        ...
        >
            ...
            >
                <View style={styles.createSheetContainer}>
                    <TextBox style={styles.mainHeader}>Create Space</TextBox>
                    ...
                    <Pressable
                        style={styles.Btn}
                        onPress={handleSubmit(handleCreateSpace)}
                    >
                        <TextBox style={styles.btnText}>Create Space</TextBox>
                    </Pressable>
                </View>
            </BottomSheetScrollView>
        </BottomSheet>
